...
public class TypePropositionServiceImpl implements ITypePropositionService {
	...
	@Override
	public TypeProposition createTypeProposition(@Valid TypePropositionDTO typePropositionDTO)
			throws EntityAlreadyExistsException {
		Optional<TypeProposition> typePropositionToCreate = typePropositionRepository
				.findByTypeName(typePropositionDTO.getTypeName());
