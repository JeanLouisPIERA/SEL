...
public class ArticleRestController {
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "L'article a été créée"),
			...
			@ApiResponse(code = 409, message = "Un autre article existe déjà avec ces attributs"), })
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "L'article recherché a été trouvé"),
			@ApiResponse(code = 400, message = "Les informations fournies ne sont pas correctes"),
			@ApiResponse(code = 413, message = "L'article que vous voulez consulter n'existe pas"), })
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "L'article recherché a été trouvé"),
			@ApiResponse(code = 400, message = "Les informations fournies ne sont pas correctes"),
			@ApiResponse(code = 413, message = "L'article que vous voulez publier n'existe pas"), })
