...
import com.microselwebui.microselwebui.service.UserService;
...
public class UserController {
	...
	public String showRegistrationForm(Model model) {
	  ...
	  try { ResponseEntity<UserBean> reponseAdherentCreated =
	  adherentsProxy.enregistrerCompteAdherent(userDTO); } catch
	...
	public String selIndex(Model model, @PathVariable() Long id) {
	  ...
	  Page<UserBean> adherentsPage = userService.findPaginated(adherents,
