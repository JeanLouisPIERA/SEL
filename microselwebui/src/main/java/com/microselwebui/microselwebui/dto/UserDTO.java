package com.microselwebui.microselwebui.dto;
...
import com.microselwebui.microselwebui.constraints.FieldValidation;
...
@Size(min = 5, max = 25, message = "Votre identifiant doit contenir entre 5 et 25 caractères")
...
@AssertTrue (message="Vous devez accepter nos conditions générales d'utilisation pour valider votre demande d'adhésion")
