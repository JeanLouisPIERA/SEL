...
<div class="row d-flex justify-content-center">
 ...
 <div class="panel panel-primary ">
  ...
  <div class="panel-heading">
   <h5>Merci ${pageContext.request.userPrincipal.name} : votre proposition a bien été clôturée</h5>
  </div>
  ...
  <div class="panel-body">
   <table class="table table-striped table-condensed table-bordered">
    <thead>
        <tr>
            <th colspan="2"> Clôture de la proposition N° : ${proposition.id} sous votre dossier Adhérent N° ${proposition.emetteurId}</th>
        </tr>
    </thead>
    <tbody>
         <tr>
