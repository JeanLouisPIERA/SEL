   ...
   <div class="panel panel-primary">
    ...
    <h3><center>Recherche des échanges enregistrés</center></h3>
	    ...
	    <div class="panel-body">
				 ...
				 <form:form class="form-inline d-flex bd-highlight" action="/echanges/recepteur" method="GET" modelAttribute="echange">
	...
	<div class="row d-flex justify-content-center">
		<div class="container col-md-10 col-md-offset-1">
			<div class="wrapper">
				 <div class="panel panel-primary">
				  <div class="panel-heading">
				   <h3><center>Echanges sur les réponses de ${pageContext.request.userPrincipal.name} </center></h3>
				  </div>
  					<div class="panel-body">
			    			...
			    			<c:if test="${echanges.size() > 0 }">
					            ...
					            <ul class="nav nav-pills">
					                <c:forEach begin="0" end="${totalPages-1}" var="page">
					                    <li class="page-item">
					                        <a class="btn btn-info" href="recepteur?page=${page}&size=${size}" class="page-target">${page+1}</a>
					                    </li>
					                </c:forEach>
				           		 </ul>
					 		   </c:if>
