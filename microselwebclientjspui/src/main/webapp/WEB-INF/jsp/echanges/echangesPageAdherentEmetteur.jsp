 ...
 <div class="row justify-content-center mb-3">
  <div class="col-md-10 col-md-offset-1 ">
   ...
   <div class="panel panel-primary">
    ...
    <h3><center>Recherche des échanges enregistrées</center></h3>
    </div>
    
	    <div class="panel-body">
	
				 <form:form class="form-inline d-flex bd-highlight" action="/echanges/emetteur" method="GET" modelAttribute="echange">
				 ...
				 <fieldset class="form-group">
				 <label>Adhérent répondant:</label>
			    			...
			    			<c:if test="${echanges.size() > 0 }">
					            ...
					            <ul class="nav nav-pills">
					                <c:forEach begin="0" end="${totalPages-1}" var="page">
					                    <li class="page-item">
					                        <a class="btn btn-info" href="emetteur?page=${page}&size=${size}" class="page-target">${page+1}</a>
					                    </li>
					                </c:forEach>
				           		 </ul>
					 		   </c:if>
