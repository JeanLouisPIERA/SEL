				...
				<div class="col-md-10 col-md-offset-1 ">
					...
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3>
								<center>Recherche des adhérents enregistrées</center>
							</h3>
						</div>
						...
						<div class="panel-body">
							...
							<form:form class="form-inline d-flex bd-highlight"
								action="/accounts" method="GET" modelAttribute="account">
										...
										<ul class="nav nav-pills">
											<c:forEach begin="0" end="${totalPages-1}" var="page">
												<li class="page-item"><a class="btn btn-info"
													href="accounts?page=${page}&size=${size}" class="page-target">${page+1}</a></li>
											</c:forEach>
										</ul>
									</c:if>
								</div>
