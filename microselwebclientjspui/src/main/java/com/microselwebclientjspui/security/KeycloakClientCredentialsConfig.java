...
public class KeycloakClientCredentialsConfig {
    ...
    private ClientCredentialsResourceDetails getClientCredentialsResourceDetails() {
    	...
    	List<String> scopes = new ArrayList<String>(0); 
    	scopes.add("email profile");
    	
        ClientCredentialsResourceDetails clientCredentialsResourceDetails = 
                new ClientCredentialsResourceDetails();

        clientCredentialsResourceDetails.setAccessTokenUri("http://localhost:8180/auth/realms/microsel-realm/protocol/openid-connect/token");
