...
public enum EnumStatutEchange {
	...
	ENREGISTRE("ENREGISTRE", "ENREGISTRE"), CONFIRME("CONFIRME", "CONFIRME"), ANNULE("ANNULE", "ANNULE"),
	ECHU("ECHU", "ECHU"), CLOTURE("CLOTURE", "CLOTURE"), LITIGE("LITIGE", "LITIGE"), SUPPRIME("SUPPRIME", "SUPPRIME"),
	FORCEVALID("FORCEVALID", "FORCEVALID"), FORCEREFUS("FORCEREFUS", "FORCEREFUS"), CONFLIT("CONFLIT", "CONFLIT"),
	...
	public static List<EnumStatutEchange> getListEnumStatutEchange() {

		List<EnumStatutEchange> ListEnumStatutEchange = new ArrayList<EnumStatutEchange>();
		for (EnumStatutEchange enumStatutEchange : values()) {
			ListEnumStatutEchange.add(enumStatutEchange);
		}
		return ListEnumStatutEchange;
