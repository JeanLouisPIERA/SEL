...
public enum EnumCategorie {
	...
	BRICOLAGE("BRICOLAGE", "BRICOLAGE"), JARDINAGE("JARDINAGE", "JARDINAGE"),
	ALIMENTATION("ALIMENTATION", "ALIMENTATION"), BROCANTE("BROCANTE", "BROCANTE"), COURS("COURS", "COURS"),
	LANGUE("LANGUE", "LANGUE"), ACCOMPAGNEMENT("ACCOMPAGNEMENT", "ACCOMPAGNEMENT"),
	COVOITURAGE("COVOITURAGE", "COVOITURAGE"), PRET("PRET", "PRET"), INCONNUE("INCONNUE", "INCONNUE");
	...
	public static List<EnumCategorie> getListEnumCategorie() {

		List<EnumCategorie> ListEnumCategorie = new ArrayList<EnumCategorie>();
		for (EnumCategorie enumCategorie : values()) {
			ListEnumCategorie.add(enumCategorie);
		}
		return ListEnumCategorie;
