...
public class TypePropositionServiceImpl implements ITypePropositionService{
	...
	@Autowired private RestTemplate restTemplate;
	 ...
	 @Value("${application.uRLTypeProposition}") private String uRLTypeProposition;
	...
	public TypeProposition createTypeDocument(TypePropositionDTO typePropositionDTO) {
    	...
    	ResponseEntity<TypeProposition> response =restTemplate.exchange(uRLTypeProposition, HttpMethod.POST, requestEntity, 
			              TypeProposition.class);
