...
public class DocumentServiceImpl implements IDocumentService{
	...
	@Value("${application.uRLDocument}") private String uRLDocument;
	...
	public Page<Document> searchByCriteria(DocumentCriteria documentCriteria, Pageable pageable) {
		...
		ResponseEntity<RestResponsePage<Document>> documents = restTemplate.exchange
  			(builder.build().toUriString(), 
				HttpMethod.GET,
				entity,
  			new ParameterizedTypeReference<RestResponsePage<Document>>(){});
