...
//CREATE PROPOSITION *****************************************************************************************************
	...
	/**
	 * Permet d'afficher le formulaire de création d'une réponse en injectant les
	 * attributs de la proposition
	 */
	...
	public String createReponse(Model model, @PathVariable Long id, @ModelAttribute("reponseDTO") ReponseDTO reponseDTO,
