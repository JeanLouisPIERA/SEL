...
public class AdherentExceptionHandler {
	...
	public AdherentExceptionReponse handleCustomException(EntityNotFoundException ex) {
	...
	public AdherentExceptionReponse handleCustomException(UsernameNotAvailableException ex1) {
		AdherentExceptionReponse exceptionReponse = new AdherentExceptionReponse();
		exceptionReponse.setLocalDate(LocalDate.now());
	...
	public AdherentExceptionReponse handleCustomException(AdresseMailAlreadyExistsException ex2) {
		AdherentExceptionReponse exceptionReponse = new AdherentExceptionReponse();
		exceptionReponse.setLocalDate(LocalDate.now());
