package com.microseladherent.security;
...
public class SecurityConfig {
	 ...
	 * authorizeRequests() .antMatchers("/users/unprotected-data").permitAll()
	 ...
	 *//**
		 ...
		 *//*
			 ...
			 * 
			 * FilterRegistrationBean<?> registrationBean = new
			 * FilterRegistrationBean<>(filter); registrationBean.setEnabled(false); return
			 * registrationBean; }
			 * 
			 * @Bean public FilterRegistrationBean<?>
			 ...
			 * 
			 * @Bean public FilterRegistrationBean<?>
			 * keycloakSecurityContextRequestFilterBean(
