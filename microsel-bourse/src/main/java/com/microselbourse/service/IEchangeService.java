...
public interface IEchangeService {
	...
	Echange refuserEchangeEmetteur(@Valid Long id, Echange echangeToRefuse, UserBean emetteur, UserBean recepteur)
			throws EntityNotFoundException, DeniedAccessException, UnsupportedEncodingException, MessagingException,
			EntityAlreadyExistsException;

	Echange validerEchangeEmetteur(@Valid Long id, Echange echangeToValidate, UserBean emetteur, UserBean recepteur)
			throws EntityNotFoundException, DeniedAccessException, UnsupportedEncodingException, MessagingException,
			EntityAlreadyExistsException;

	Echange refuserEchangeRecepteur(@Valid Long id, Echange echangeToRefuse, UserBean emetteur, UserBean recepteur)
			throws EntityNotFoundException, DeniedAccessException, UnsupportedEncodingException, MessagingException,
			EntityAlreadyExistsException;

	Echange validerEchangeRecepteur(@Valid Long id, Echange echangeToValidate, UserBean emetteur, UserBean recepteur)
			throws EntityNotFoundException, DeniedAccessException, UnsupportedEncodingException, MessagingException,
			EntityAlreadyExistsException;
	...
	Echange validerEchange(@Valid Long id, String intervenantId) throws EntityNotFoundException, DeniedAccessException,
			UnsupportedEncodingException, EntityAlreadyExistsException, MessagingException;

	Echange refuserEchange(@Valid Long id, String intervenantId) throws EntityNotFoundException, DeniedAccessException,
			UnsupportedEncodingException, EntityAlreadyExistsException, MessagingException;
