...
public class BlocageServiceImpl implements IBlocageService {
	...
	@Override
	public Blocage createBlocage(Long echangeId, Long adherentId) throws EntityNotFoundException {
		...
		UserBean adherentToBlock = adherentsProxy.consulterCompteAdherent(adherentId) ;
		...
		if (!echangeAtOrigin.isPresent())
			throw new EntityNotFoundException("L'échange auquel on fait référence pour créer le blocage n'existe pas pour l'adherent indiqué");
	...
	@Override
	public Blocage annulerBlocage(Long adherentId) throws EntityNotFoundException {
	...
	@Override
	public Blocage readBlocage(Long adherentId) throws EntityNotFoundException {
