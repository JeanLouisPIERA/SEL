...
public class EchangeServiceImplTest {
	...
	@Mock
	  ...
	  public void setUp() {
		 ...
		 when(adherentProxy.consulterCompteAdherent((long)1)).thenReturn(emetteur1); 
		 when(adherentProxy.consulterCompteAdherent((long)2)).thenReturn(recepteur2);
	  ...
	  public void testReadEchange_whenEntityNotFoundException() {
		  ...
		  try {
				...
				assertThat(e).isInstanceOf(EntityNotFoundException.class).hasMessage("L'échange que vous voulez consulter n'existe pas");
			}
	  }
